# [ArpackMKL](@id lib-itereigen)

```@meta
DocTestSetup = :(using ArpackMKL, LinearAlgebra, SparseArrays)
```

This package provides bindings to [ArpackMKL](http://www.caam.rice.edu/software/ArpackMKL/), which
