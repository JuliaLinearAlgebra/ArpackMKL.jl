...
No deps.jl file could be found. Please try running Pkg.build("ArpackMKL").
...
For more info see https://github.com/JuliaLinearAlgebra/ArpackMKL.jl/issues/5.
"""))
end
...
function _eigs(A, B;
    ...
    # Refer to ex-*.doc files in ArpackMKL/DOCUMENTS for calling sequence
